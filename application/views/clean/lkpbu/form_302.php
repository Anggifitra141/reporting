...
$('#nav-lkpbu-clean-302').addClass('active');
  ...
  $(document).ready(function() {
     ...
     table_card = $('#table-card').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?php echo site_url('clean/ajax_list_lkpbu_card')?>", // json dataclean
        type: "POST",
        data: function(data) {
    ...
    table_dana_float = $('#table-dana-float').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?php echo site_url('clean/ajax_list_lkpbu_dana_float')?>", // json dataclean
        type: "POST",
        data: function(data) {
    ...
    table_trx = $('#table-trx').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?php echo site_url('clean/ajax_list_lkpbu_trx')?>", // json dataclean
        type: "POST",
        data: function(data) {
    ...
    table_vol = $('#table-vol').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?php echo site_url('clean/ajax_list_lkpbu_vol')?>", // json dataclean
        type: "POST",
        data: function(data) {
