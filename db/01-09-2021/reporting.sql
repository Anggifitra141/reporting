...
-- Dumping structure for table regulatory.t0source_danafloat
CREATE TABLE IF NOT EXISTS `t0source_danafloat` (
  ...
  PRIMARY KEY (`id`),
  KEY `trx_datetime` (`trx_datetime`),
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=latin1 COMMENT='Table source for Dana Float report';

-- Dumping data for table regulatory.t0source_danafloat: ~50 rows (approximately)
/*!40000 ALTER TABLE `t0source_danafloat` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t0source_danafloat` ENABLE KEYS */;

-- Dumping structure for table regulatory.t0source_ltdbb
CREATE TABLE IF NOT EXISTS `t0source_ltdbb` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=latin1 COMMENT='Table source for LTDBB report (G001, G002, G003)';

-- Dumping data for table regulatory.t0source_ltdbb: ~51 rows (approximately)
/*!40000 ALTER TABLE `t0source_ltdbb` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t0source_ltdbb` ENABLE KEYS */;

-- Dumping structure for table regulatory.t0source_ltkl
CREATE TABLE IF NOT EXISTS `t0source_ltkl` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Table source for LTKL report';

-- Dumping data for table regulatory.t0source_ltkl: ~9 rows (approximately)
/*!40000 ALTER TABLE `t0source_ltkl` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t0source_ltkl` ENABLE KEYS */;

-- Dumping structure for table regulatory.t0source_sipesat
CREATE TABLE IF NOT EXISTS `t0source_sipesat` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 COMMENT='Table source for SIPESAT report';

-- Dumping data for table regulatory.t0source_sipesat: ~16 rows (approximately)
/*!40000 ALTER TABLE `t0source_sipesat` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t0source_sipesat` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_danafloat
CREATE TABLE IF NOT EXISTS `t1clean_danafloat` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.t1clean_danafloat: ~0 rows (approximately)
/*!40000 ALTER TABLE `t1clean_danafloat` DISABLE KEYS */;
/*!40000 ALTER TABLE `t1clean_danafloat` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_lkpbu_309_310_311
CREATE TABLE IF NOT EXISTS `t1clean_lkpbu_309_310_311` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=latin1 COMMENT='Table clean for LKPBU (form 309, 310, 311)';

-- Dumping data for table regulatory.t1clean_lkpbu_309_310_311: ~100 rows (approximately)
/*!40000 ALTER TABLE `t1clean_lkpbu_309_310_311` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t1clean_lkpbu_309_310_311` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_lkpbu_312
CREATE TABLE IF NOT EXISTS `t1clean_lkpbu_312` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.t1clean_lkpbu_312: ~0 rows (approximately)
/*!40000 ALTER TABLE `t1clean_lkpbu_312` DISABLE KEYS */;
/*!40000 ALTER TABLE `t1clean_lkpbu_312` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_lkpbu_313
CREATE TABLE IF NOT EXISTS `t1clean_lkpbu_313` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `publication_code` varchar(5) NOT NULL,
  `description` varchar(250) NOT NULL,
...
-- Dumping data for table regulatory.t1clean_lkpbu_313: ~0 rows (approximately)
/*!40000 ALTER TABLE `t1clean_lkpbu_313` DISABLE KEYS */;
/*!40000 ALTER TABLE `t1clean_lkpbu_313` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_ltdbb
CREATE TABLE IF NOT EXISTS `t1clean_ltdbb` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_source` int(12) NOT NULL,
  `sender_country` varchar(100) NOT NULL,
  `sender_city` varchar(100) NOT NULL,
  ...
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Table clean for LTDBB report (G001, G002, G003)';

-- Dumping data for table regulatory.t1clean_ltdbb: ~3 rows (approximately)
/*!40000 ALTER TABLE `t1clean_ltdbb` DISABLE KEYS */;
INSERT INTO `t1clean_ltdbb` (`id`, `id_source`, `sender_country`, `sender_city`, `recept_country`, `recept_city`, `sender_name`, `recept_name`, `sender_phone`, `recept_phone`, `sender_wn`, `recept_wn`, `description`, `trx_freq`, `trx_amount`, `trx_traffic`, `trx_type`, `trx_date`, `datestamp`, `status`) VALUES
	...
	(5, 2, 'INDONESIA', '0102 - Kab. Bekasi', 'INDONESIA', '6301 - Kab. Gorontalo', 'HERU SUCAHYO', 'HENIS', '', '+6285346565773', '', '', 'Anda mendapat kiriman sebesar 800000 dari Heru Sucahyo ke no rek.1480017881858', '', '800000', '', 'C2B', '2021-08-20', '2021082612', 'cleaned'),
	(6, 3, 'INDONESIA', '0102 - Kab. Bekasi', 'INDONESIA', '6301 - Kab. Gorontalo', 'PRATAMA ADHE PUTRA', 'ARRAHMANa', '', '+6288225643969', '', '', 'Anda mendapat kiriman sebesar 200000 dari PRATAMA ADHE PUTRA ke no rek.2910696541', '', '200000', '', 'C2B', '2021-08-21', '20210826', 'cleaned');
/*!40000 ALTER TABLE `t1clean_ltdbb` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_ltkl
CREATE TABLE IF NOT EXISTS `t1clean_ltkl` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_source` int(12) NOT NULL,
  `sender_name` varchar(50) NOT NULL,
  `sender_country` varchar(50) NOT NULL,
...
-- Dumping data for table regulatory.t1clean_ltkl: ~0 rows (approximately)
/*!40000 ALTER TABLE `t1clean_ltkl` DISABLE KEYS */;
/*!40000 ALTER TABLE `t1clean_ltkl` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_sipesat
CREATE TABLE IF NOT EXISTS `t1clean_sipesat` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_source` int(12) NOT NULL,
  `customer_code` varchar(20) NOT NULL,
  `customer_name` varchar(100) NOT NULL,
  ...
  KEY `status` (`status`),
  KEY `id_source` (`id_source`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Table clean for SIPESAT report';

-- Dumping data for table regulatory.t1clean_sipesat: ~33 rows (approximately)
/*!40000 ALTER TABLE `t1clean_sipesat` DISABLE KEYS */;
INSERT INTO `t1clean_sipesat` (`id`, `id_source`, `customer_code`, `customer_name`, `birth_place`, `birth_date`, `address`, `id_card_number`, `id_card_number_other`, `customer_cif`, `register_date`, `customer_type`, `trx_date`, `datestamp`, `status`) VALUES
	(1, 1, 'AB', 'A', 'A', '20210808', 'a', '123', '123', '123', '', '', '', '20210808', 'cleaned');
/*!40000 ALTER TABLE `t1clean_sipesat` ENABLE KEYS */;

-- Dumping structure for table regulatory.t1clean_syscrash
CREATE TABLE IF NOT EXISTS `t1clean_syscrash` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table regulatory.t1clean_syscrash: ~0 rows (approximately)
/*!40000 ALTER TABLE `t1clean_syscrash` DISABLE KEYS */;
/*!40000 ALTER TABLE `t1clean_syscrash` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_danafloat
CREATE TABLE IF NOT EXISTS `t2archive_danafloat` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  KEY `datestamp` (`datestamp`),
  KEY `status` (`status`),
  KEY `id_clean` (`id_clean`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table archive for Dana Float report';

-- Dumping data for table regulatory.t2archive_danafloat: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_danafloat` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_danafloat` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_lkpbu_309_310_311
CREATE TABLE IF NOT EXISTS `t2archive_lkpbu_309_310_311` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_clean` int(12) NOT NULL,
  `ticket_no` varchar(20) NOT NULL,
  `ticket_status` varchar(10) NOT NULL,
...
-- Dumping data for table regulatory.t2archive_lkpbu_309_310_311: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_lkpbu_309_310_311` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_lkpbu_309_310_311` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_lkpbu_312
CREATE TABLE IF NOT EXISTS `t2archive_lkpbu_312` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_clean` int(12) NOT NULL,
  `publication_code` varchar(5) NOT NULL,
  `description` varchar(250) NOT NULL,
...
-- Dumping data for table regulatory.t2archive_lkpbu_312: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_lkpbu_312` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_lkpbu_312` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_lkpbu_313
CREATE TABLE IF NOT EXISTS `t2archive_lkpbu_313` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_clean` int(12) NOT NULL,
  `publication_code` varchar(5) NOT NULL,
  `description` varchar(250) NOT NULL,
...
-- Dumping data for table regulatory.t2archive_lkpbu_313: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_lkpbu_313` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_lkpbu_313` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_ltdbb
CREATE TABLE IF NOT EXISTS `t2archive_ltdbb` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_clean` int(12) NOT NULL,
  `sender_country` varchar(100) NOT NULL,
  `sender_city` varchar(100) NOT NULL,
...
-- Dumping data for table regulatory.t2archive_ltdbb: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_ltdbb` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_ltdbb` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_ltkl
CREATE TABLE IF NOT EXISTS `t2archive_ltkl` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_clean` int(12) NOT NULL,
  `sender_name` varchar(50) NOT NULL,
  `sender_country` varchar(50) NOT NULL,
...
-- Dumping data for table regulatory.t2archive_ltkl: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_ltkl` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_ltkl` ENABLE KEYS */;

-- Dumping structure for table regulatory.t2archive_sipesat
CREATE TABLE IF NOT EXISTS `t2archive_sipesat` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `id_clean` int(12) NOT NULL,
  `customer_code` varchar(20) NOT NULL,
  `customer_name` varchar(100) NOT NULL,
...
-- Dumping data for table regulatory.t2archive_sipesat: ~0 rows (approximately)
/*!40000 ALTER TABLE `t2archive_sipesat` DISABLE KEYS */;
/*!40000 ALTER TABLE `t2archive_sipesat` ENABLE KEYS */;

-- Dumping structure for table regulatory.t3calendar
CREATE TABLE IF NOT EXISTS `t3calendar` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1 COMMENT='Table Master';

-- Dumping data for table regulatory.t3calendar: ~34 rows (approximately)
/*!40000 ALTER TABLE `t3calendar` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t3calendar` ENABLE KEYS */;

-- Dumping structure for table regulatory.t3report_period
CREATE TABLE IF NOT EXISTS `t3report_period` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `period_code` varchar(20) NOT NULL,
  `period_name` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='Table Master';

-- Dumping data for table regulatory.t3report_period: ~4 rows (approximately)
/*!40000 ALTER TABLE `t3report_period` DISABLE KEYS */;
INSERT INTO `t3report_period` (`id`, `period_code`, `period_name`) VALUES
	(1, '1D', 'Daily'),
	(2, '1M', 'Montly'),
	(3, '1W', 'Weekly'),
	(4, '3M', '3 Monthly');
/*!40000 ALTER TABLE `t3report_period` ENABLE KEYS */;

-- Dumping structure for table regulatory.t3report_settings
CREATE TABLE IF NOT EXISTS `t3report_settings` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='Table Master';

-- Dumping data for table regulatory.t3report_settings: ~20 rows (approximately)
/*!40000 ALTER TABLE `t3report_settings` DISABLE KEYS */;
INSERT INTO `t3report_settings` (`id`, `code`, `name`, `period`, `days`, `regulator`, `format`, `header1`, `header2`, `header3`, `header4`, `header5`, `picupdate`, `status`, `link`, `datestamp`, `last_generate`) VALUES
	...
	(4, 'LTKL', 'Laporan LTKL Transfer Dana (Laporan Transaksi Ke dan Dari Luar Negeri)', '1D', '1', 'PPATK', 'X004', '', '', '', '', '', '1', 'inactive', '', '20210101', ''),
	...
	(7, 'DFUD', 'Laporan Dana Float Uang Elektronik', '1D', '1', 'Bank Indonesia', 'X007', '', '', '', '', '', '1', 'inactive', '', '20210101', ''),
	(8, 'DFUW', 'Laporan Dana Float Uang Elektronik', '1W', '1', 'Bank Indonesia', 'X008', '', '', '', '', '', '1', 'inactive', '', '20210101', ''),
	(9, 'PAYMENT_GATEWAY', 'Laporan Payment Gateway', '1M', '1', 'Bank Indonesia', 'X009', '', '', '', '', '', '1', 'inactive', '', '20210101', ''),
	(10, 'SIPESAT', 'Laporan SIPESAT (Sistem Informasi Pengguna Jasa Terpadu) (Data Pelanggan Uang Elektronik)', '3M', '1', 'PPATK', 'X010', '', '', '', '', '', '1', 'inactive', '', '20210101', ''),
...
/*!40000 ALTER TABLE `t3report_settings` ENABLE KEYS */;

-- Dumping structure for table regulatory.t3role_model
CREATE TABLE IF NOT EXISTS `t3role_model` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='Table Master';

-- Dumping data for table regulatory.t3role_model: ~4 rows (approximately)
/*!40000 ALTER TABLE `t3role_model` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t3role_model` ENABLE KEYS */;

-- Dumping structure for table regulatory.t4log_sys
CREATE TABLE IF NOT EXISTS `t4log_sys` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.t4log_sys: ~0 rows (approximately)
/*!40000 ALTER TABLE `t4log_sys` DISABLE KEYS */;
/*!40000 ALTER TABLE `t4log_sys` ENABLE KEYS */;

-- Dumping structure for table regulatory.t4log_trx
CREATE TABLE IF NOT EXISTS `t4log_trx` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `event_time` varchar(20) NOT NULL,
  `id_user` varchar(20) NOT NULL,
  `event_modul` varchar(50) NOT NULL,
...
-- Dumping data for table regulatory.t4log_trx: ~0 rows (approximately)
/*!40000 ALTER TABLE `t4log_trx` DISABLE KEYS */;
/*!40000 ALTER TABLE `t4log_trx` ENABLE KEYS */;

-- Dumping structure for table regulatory.t4log_user
CREATE TABLE IF NOT EXISTS `t4log_user` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `event_time` varchar(20) NOT NULL,
  `id_user` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.t4log_user: ~6 rows (approximately)
/*!40000 ALTER TABLE `t4log_user` DISABLE KEYS */;
INSERT INTO `t4log_user` (`id`, `event_time`, `id_user`, `ip_address`, `event_modul`, `event_type`, `record_id`, `event_notes`, `event_sql`) VALUES
	(1, '20210830113624', '1', '::1', 'LOGOUT', 'LOGOUT', '', 'User Logout', ''),
	(2, '20210830113627', '1', '::1', 'LOGIN', 'LOGIN', '', 'Successfuly user login', ''),
	(3, '20210830113627', '1', '::1', 'LOGIN', 'LOGIN', '', 'Successfuly user login', ''),
	(4, '20210830202939', '1', '::1', 'LOGIN', 'LOGIN', '', 'Successfuly user login', ''),
	(5, '20210830202939', '1', '::1', 'LOGIN', 'LOGIN', '', 'Successfuly user login', ''),
	(6, '20210831213914', '1', '::1', 'LOGIN', 'LOGIN', '', 'Successfuly user login', ''),
	(7, '20210831213914', '1', '::1', 'LOGIN', 'LOGIN', '', 'Successfuly user login', '');
/*!40000 ALTER TABLE `t4log_user` ENABLE KEYS */;

-- Dumping structure for table regulatory.t4user
CREATE TABLE IF NOT EXISTS `t4user` (
  `id` int(12) NOT NULL,
  ...
  `status` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_groups` (`user_group`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table regulatory.t4user: ~1 rows (approximately)
/*!40000 ALTER TABLE `t4user` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t4user` ENABLE KEYS */;

-- Dumping structure for table regulatory.t4user_group
CREATE TABLE IF NOT EXISTS `t4user_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.t4user_group: ~2 rows (approximately)
/*!40000 ALTER TABLE `t4user_group` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `t4user_group` ENABLE KEYS */;

-- Dumping structure for table regulatory.tlkpbu_312_publication_type
CREATE TABLE IF NOT EXISTS `tlkpbu_312_publication_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.tlkpbu_312_publication_type: ~5 rows (approximately)
/*!40000 ALTER TABLE `tlkpbu_312_publication_type` DISABLE KEYS */;
INSERT INTO `tlkpbu_312_publication_type` (`id`, `code`, `publication`) VALUES
	...
	(5, '999', 'Lainnya');
/*!40000 ALTER TABLE `tlkpbu_312_publication_type` ENABLE KEYS */;

-- Dumping structure for table regulatory.tlkpbu_313_publication_type
CREATE TABLE IF NOT EXISTS `tlkpbu_313_publication_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(5) NOT NULL,
  `publication` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping data for table regulatory.tlkpbu_313_publication_type: ~5 rows (approximately)
/*!40000 ALTER TABLE `tlkpbu_313_publication_type` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tlkpbu_313_publication_type` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltdbb_alto_city
CREATE TABLE IF NOT EXISTS `tltdbb_alto_city` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.tltdbb_alto_city: ~526 rows (approximately)
/*!40000 ALTER TABLE `tltdbb_alto_city` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltdbb_alto_city` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltdbb_bi_city
CREATE TABLE IF NOT EXISTS `tltdbb_bi_city` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table regulatory.tltdbb_bi_city: ~559 rows (approximately)
/*!40000 ALTER TABLE `tltdbb_bi_city` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltdbb_bi_city` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltdbb_bi_country
CREATE TABLE IF NOT EXISTS `tltdbb_bi_country` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `bi_code` varchar(10) NOT NULL,
...
-- Dumping data for table regulatory.tltdbb_bi_country: ~12 rows (approximately)
/*!40000 ALTER TABLE `tltdbb_bi_country` DISABLE KEYS */;
INSERT INTO `tltdbb_bi_country` (`id`, `bi_code`, `country`, `bi_country`) VALUES
	...
	(12, '86', 'INDONESIA', '');
/*!40000 ALTER TABLE `tltdbb_bi_country` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_01_subtype
CREATE TABLE IF NOT EXISTS `tltkl_01_subtype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_01_subtype: ~2 rows (approximately)
/*!40000 ALTER TABLE `tltkl_01_subtype` DISABLE KEYS */;
INSERT INTO `tltkl_01_subtype` (`id`, `code`, `description`, `status`) VALUES
	(1, 'E', 'Elektronis', 'active'),
	(2, 'M', 'Manual', 'active');
/*!40000 ALTER TABLE `tltkl_01_subtype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_02_fundtype
CREATE TABLE IF NOT EXISTS `tltkl_02_fundtype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_02_fundtype: ~6 rows (approximately)
/*!40000 ALTER TABLE `tltkl_02_fundtype` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_02_fundtype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_03_acctype
CREATE TABLE IF NOT EXISTS `tltkl_03_acctype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_03_acctype: ~6 rows (approximately)
/*!40000 ALTER TABLE `tltkl_03_acctype` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_03_acctype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_04_accstat
CREATE TABLE IF NOT EXISTS `tltkl_04_accstat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_04_accstat: ~4 rows (approximately)
/*!40000 ALTER TABLE `tltkl_04_accstat` DISABLE KEYS */;
INSERT INTO `tltkl_04_accstat` (`id`, `code`, `description`, `status`) VALUES
	(1, 'AKT', 'Aktif', 'active'),
	(2, 'DOR', 'Dormant', 'active'),
	(3, 'TTP', 'Tutup', 'active'),
	(4, 'BLK', 'Blokir', 'active');
/*!40000 ALTER TABLE `tltkl_04_accstat` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_05_idtype
CREATE TABLE IF NOT EXISTS `tltkl_05_idtype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_05_idtype: ~7 rows (approximately)
/*!40000 ALTER TABLE `tltkl_05_idtype` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_05_idtype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_06_trxmode
CREATE TABLE IF NOT EXISTS `tltkl_06_trxmode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_06_trxmode: ~21 rows (approximately)
/*!40000 ALTER TABLE `tltkl_06_trxmode` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_06_trxmode` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_07_trxtype
CREATE TABLE IF NOT EXISTS `tltkl_07_trxtype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_07_trxtype: ~8 rows (approximately)
/*!40000 ALTER TABLE `tltkl_07_trxtype` DISABLE KEYS */;
INSERT INTO `tltkl_07_trxtype` (`id`, `code`, `description`, `status`) VALUES
	...
	(7, 'LLG', 'Lelang', 'active'),
	(8, 'HIB', 'Hibah', 'active');
/*!40000 ALTER TABLE `tltkl_07_trxtype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_08_reporttype
CREATE TABLE IF NOT EXISTS `tltkl_08_reporttype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_08_reporttype: ~15 rows (approximately)
/*!40000 ALTER TABLE `tltkl_08_reporttype` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_08_reporttype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_09_contactcat
CREATE TABLE IF NOT EXISTS `tltkl_09_contactcat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_09_contactcat: ~3 rows (approximately)
/*!40000 ALTER TABLE `tltkl_09_contactcat` DISABLE KEYS */;
INSERT INTO `tltkl_09_contactcat` (`id`, `code`, `description`, `status`) VALUES
	(1, 'K', 'Kantor', 'active'),
	(2, 'R', 'Rumah', 'active'),
	(3, 'D', 'Domisili', 'active');
/*!40000 ALTER TABLE `tltkl_09_contactcat` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_10_commtype
CREATE TABLE IF NOT EXISTS `tltkl_10_commtype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_10_commtype: ~4 rows (approximately)
/*!40000 ALTER TABLE `tltkl_10_commtype` DISABLE KEYS */;
INSERT INTO `tltkl_10_commtype` (`id`, `code`, `description`, `status`) VALUES
	(1, 'PSTN', 'PSTN', 'active'),
	(2, 'FAX', 'Fax', 'active'),
	(3, 'MOB', 'Mobile', 'active'),
	(4, 'SAT', 'Satelit', 'active');
/*!40000 ALTER TABLE `tltkl_10_commtype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_11_companytype
CREATE TABLE IF NOT EXISTS `tltkl_11_companytype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_11_companytype: ~13 rows (approximately)
/*!40000 ALTER TABLE `tltkl_11_companytype` DISABLE KEYS */;
INSERT INTO `tltkl_11_companytype` (`id`, `code`, `description`, `status`) VALUES
	...
	(13, 'OTH', 'Lainnya', 'active');
/*!40000 ALTER TABLE `tltkl_11_companytype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_12_stufftype
CREATE TABLE IF NOT EXISTS `tltkl_12_stufftype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_12_stufftype: ~5 rows (approximately)
/*!40000 ALTER TABLE `tltkl_12_stufftype` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_12_stufftype` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_13_currency
CREATE TABLE IF NOT EXISTS `tltkl_13_currency` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_13_currency: ~189 rows (approximately)
/*!40000 ALTER TABLE `tltkl_13_currency` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_13_currency` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_14_country
CREATE TABLE IF NOT EXISTS `tltkl_14_country` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_14_country: ~0 rows (approximately)
/*!40000 ALTER TABLE `tltkl_14_country` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_14_country` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_15_personacc
CREATE TABLE IF NOT EXISTS `tltkl_15_personacc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_15_personacc: ~0 rows (approximately)
/*!40000 ALTER TABLE `tltkl_15_personacc` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_15_personacc` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_16_personentity
CREATE TABLE IF NOT EXISTS `tltkl_16_personentity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_16_personentity: ~0 rows (approximately)
/*!40000 ALTER TABLE `tltkl_16_personentity` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tltkl_16_personentity` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_17_partyrole
CREATE TABLE IF NOT EXISTS `tltkl_17_partyrole` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_17_partyrole: ~0 rows (approximately)
/*!40000 ALTER TABLE `tltkl_17_partyrole` DISABLE KEYS */;
INSERT INTO `tltkl_17_partyrole` (`id`, `code`, `description`, `status`) VALUES
	...
	(10, 'OTH', 'Lainnya', 'active');
/*!40000 ALTER TABLE `tltkl_17_partyrole` ENABLE KEYS */;

-- Dumping structure for table regulatory.tltkl_19_gender
CREATE TABLE IF NOT EXISTS `tltkl_19_gender` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(20) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(20) NOT NULL,
...
-- Dumping data for table regulatory.tltkl_19_gender: ~0 rows (approximately)
/*!40000 ALTER TABLE `tltkl_19_gender` DISABLE KEYS */;
INSERT INTO `tltkl_19_gender` (`id`, `code`, `description`, `status`) VALUES
	(1, 'L', 'Laki-laki', 'active'),
	(2, 'P', 'Perempuan', 'active');
/*!40000 ALTER TABLE `tltkl_19_gender` ENABLE KEYS */;
