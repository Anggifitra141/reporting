<section class="section">
  ...
  <div class="section-body">
    <div class="row">
      <div class="col-md-3">
        <h2 class="section-title">Desember 2021</h2>
      </div>
      <div class="col-md-2">
      ...
      <div class="col-12">
        <div class="activities">
          <div class="activity">
            ...
            <div class="activity-detail">
              <div class="mb-2">
                ...
                <a class="text-job" href="#">Clean Source</a>
                <span class="bullet"></span>
                <a class="text-job text-primary" href="#">Admin</a>
          ...
          <div class="activity">
            ...
            <div class="activity-detail">
              <div class="mb-2">
                ...
                <span class="bullet"></span>
                <a class="text-job" href="#">Upload Source</a>
                <span class="bullet"></span>
                <a class="text-job text-primary" href="#">Operator</a>
                <div class="float-right dropdown">
                  <a href="#" data-toggle="dropdown"><i class="fas fa-ellipsis-h"></i></a>
                  <div class="dropdown-menu">
                    <div class="dropdown-title">Options</div>
              ...
              <p>Moved the task "<a href="#">Fix some features that are bugs in the master module</a>" from Progress to
                Finish.</p>
            </div>
          </div>
          <div class="activity">
            ...
            <div class="activity-detail">
              <div class="mb-2">
                ...
                <span class="bullet"></span>
                <a class="text-job" href="#">Update</a>
                <span class="bullet"></span>
                <a class="text-job text-primary" href="#">Admin</a>
                <div class="float-right dropdown">
                  <a href="#" data-toggle="dropdown"><i class="fas fa-ellipsis-h"></i></a>
          ...
          <div class="activity">
            ...
            <div class="activity-detail">
              <div class="mb-2">
                ...
                <span class="bullet"></span>
                <a class="text-job" href="#">Delete</a>
                <span class="bullet"></span>
                <a class="text-job text-primary" href="#">Admin</a>
                <div class="float-right dropdown">
                  <a href="#" data-toggle="dropdown"><i class="fas fa-ellipsis-h"></i></a>
          ...
          <div class="text-center">
            <button class="btn btn-icon btn-outline-primary"> <i class="fas fa-history"></i> View more </button>
          </div>
        </div>
      </div>
    </div>
