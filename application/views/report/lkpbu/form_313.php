...
<section class="section">
  ...
  <div class="section-body">
    <h2 class="section-title">Manage Report LKPBU FORM 313</h2>
...
<script>
  ...
  $('#nav-lkpbu-report-313').addClass('active');
    ...
    $('#btn-view').click(function() {
      ...
      if (daterange) {
        ...
        table = $('#table').DataTable({
          ...
          "order": [],
          "ajax": {
            url: "<?php echo site_url('report/ajax_list_lkpbu_313') ?>", // json datasource
            type: "POST",
            data: function(data) {
        ...
        $('#btn-download-excel').attr('href', base_url + 'report/download_excel_lkpbu_313?daterange=' + daterange);
