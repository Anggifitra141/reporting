...
class M_overtime extends CI_model {
  ...
  */
	...
	var $table = 'overtime';
  var $column_order = array('no','overtime_id','overtime_type','description','overtime_hours');
  var $column_search = array('overtime_id','overtime_type','description','overtime_hours');
  var $order = array('overtime_id' => 'desc');
  ...
  public function update_overtime($where, $data)
  {
