            ...
            <li class="dropdown" id="nav-report">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="dropdown" id="nav-lkpbu-report">
                  ...
                  <ul class="dropdown-menu">
                    <li id="nav-ltdbb-source-g001"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 302</a></li>
                    <li id="nav-ltdbb-source-g002"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 303</a></li>
                    ...
                    <li id="nav-ltdbb-source-g003"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 309</a></li>
                    <li id="nav-ltdbb-source-g003"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 310</a></li>
                    <li id="nav-ltdbb-source-g003"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 311</a></li>
                    <li id="nav-ltdbb-source-g003"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 312</a></li>
                    <li id="nav-ltdbb-source-g003"><a class="nav-link" href="<?php echo site_url('report/lkpbu_304'); ?>"><i class="fas fa-circle"></i> Form 313</a></li>
                  </ul>
                </li>
